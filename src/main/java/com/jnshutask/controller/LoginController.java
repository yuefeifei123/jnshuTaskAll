...
public class LoginController {
    ...
    public String homeLogin(@ModelAttribute("login") TaLogin login) {
    ...
    public String logining(@ModelAttribute("login") TaLogin login,
                           Model model) {
...
//            model.addAttribute("status","账号或密码错误");
    ...
    public String registerAccount(@ModelAttribute("login") TaLogin login,
                                  Model model) {
    ...
    public String registerMobile(@ModelAttribute("login") TaLogin login,
                                 HttpSession session,
                                 Model model) {
    ...
    public String registerMobileing(@ModelAttribute("login") TaLogin login,//用户提交的账户信息
    ...
    public String registerMail(@ModelAttribute("login") TaLogin login,
...
//        log.info(login);
    ...
    public String registerMailing(@ModelAttribute("login") TaLogin login,
